...
export const Layout = () => {
  ...
  return (
    <>
      ...
      <Image src={logo} width={45} height={45} className="rounded-none sm:h-10 sm:w-20 md:h-20 lg:h-5 xl:h-5 sm:mr-96 mr-4" alt="Logo" />
      DULEXE 
        </div>
        <Link
          to={"/"}
          className="sm:mx-8  mx-2  relative text-black after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-white hover:after:w-full after:transition-all after:duration-300"
        >
          INICIO
        </Link>
        <Link

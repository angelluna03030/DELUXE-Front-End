...
export const DetallePedidos = () => {
  ...
  return (
    <>
      <div className='flex flex-col bg-white w-72 h-60 rounded-md py-4 px-6 border mb-32 m-auto'>
        <h3 className='text-center font-bold text-xl text-gray-800 pb-2'>
        ${total > 0 ? total : 0}
        </h3>
        <h3 className='text-base font-semibold text-gray-900'>Cantidad Productos:   {cantidad > 0 ? cantidad : 0}</h3>

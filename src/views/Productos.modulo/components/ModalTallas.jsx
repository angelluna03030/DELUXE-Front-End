...
export const ModalTallas = ({ selectedTalla: initialTalla, onTallasChange }) => {
  ...
  return (
    <>
      <Button onPress={onOpen} color="primary">Tallas</Button>
      <Modal isOpen={isOpen} onOpenChange={onOpenChange} isDismissable={false} isKeyboardDismissDisabled={true} size="4xl">
        <ModalContent>
          ...
          <ModalBody>
            <CheckboxGroup value={selectedTallas} onChange={handleCheckboxChange}>
